...
private:
  ...
  DetectorConstruction* TreatmentRoomGeom;

  G4UIdirectory* GeomDir; // Control of the geometry 
 
  G4UIcmdWith3VectorAndUnit* Absorber_size;
  G4UIcmdWithAString* Absorber_material;
  G4UIcmdWithAString* Target_material;
  G4UIcmdWithADoubleAndUnit* Target_Radius;
